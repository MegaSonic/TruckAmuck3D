...
public class STMCurveGenerator : MonoBehaviour {
	...
	void DrawCurves(){
        ...
        cos.postWrapMode = WrapMode.Loop;
        ...
        sine.postWrapMode = WrapMode.Loop;

        linear = new AnimationCurve(new Keyframe(0f,0f,1f,1f), new Keyframe(1f,1f,1f,1f));

        inverseLinear = new AnimationCurve(new Keyframe(0f,1f,-1f,-1f), new Keyframe(1f,0f,-1f,-1f));
	}
}
#endif